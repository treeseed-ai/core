...
import { loadDeployConfigFromPath } from '../../src/runtime/platform/deploy-config.ts';
...
const deployConfig = loadDeployConfigFromPath(resolve(fixtureRoot, 'treeseed.site.yaml'));
