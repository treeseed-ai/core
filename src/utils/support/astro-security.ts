...
function appendEnvironmentHostnames(hostnames: string[], environments: Iterable<ManagedServiceEnvironmentConfig | undefined>) {
...
export function deriveAstroAllowedDomains(
	deployConfig: Pick<DeployConfig, 'siteUrl' | 'surfaces'>,
