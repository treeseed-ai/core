...
const localSubscribers =
	(globalThis as { FixtureSubscribers?: Map<string, LocalSubscriberRecord> }).FixtureSubscribers
	?? new Map<string, LocalSubscriberRecord>();

(globalThis as { FixtureSubscribers?: Map<string, LocalSubscriberRecord> }).FixtureSubscribers = localSubscribers;
