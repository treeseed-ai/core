...
import { resolveFormRuntimeCapabilities } from '../runtime/runtime';
import type { CloudflareRuntime } from '../../../types/cloudflare';
import { SITE } from '../../configuration/site-config';
...
function createAstroFormConfig(context: APIContext) {
	return {
		...
		formsProvider: resolveBuiltinFormsProvider(getFormsProvider()),
