...
import { buildRedirectTarget, getRemoteIp, sanitizeRedirectTo } from '../transport/http';
import { issueFormToken, verifyIssuedToken, createSessionCookie } from '../accounts/session';
import { parsePayload, validatePayload } from '../security/validation';
import { hashValue } from '../security/crypto';
import { resolveContactRecipientsFromMap } from '../routing/routing-core';
import type { FormsProvider } from '../capacity/providers/provider-core';
import type {
	ContactSubmission,
...
export interface FormServiceConfig {
	...
	formsProvider: Required<FormsProvider>;
	formSecret: string;
