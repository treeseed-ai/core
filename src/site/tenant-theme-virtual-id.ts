...
export const PACKAGE_ROUTE_ENTRIES: Array<{ pattern: string; entrypoint?: string; resourcePath?: string; model?: ContentCollection }> = [
	...
	{ pattern: '/t/[teamSlug]/books/[bookSlug]', resourcePath: 'pages/t/[teamSlug]/books/[bookSlug]/index.astro', model: 'books' },
	{ pattern: '/t/[teamSlug]/books/[bookSlug]/[...pageSlug]', resourcePath: 'pages/t/[teamSlug]/books/[bookSlug]/[...pageSlug].astro', model: 'docs' },
